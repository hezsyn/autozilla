...
SupportStuff.create(name: 'dupPrerun2', value: 'sudo mount -t cifs #{netPath} /mnt -o vers=3.0')
...
SupportStuff.create(name: 'ddlPrerun2', value: 'sudo mount -t cifs #{netPath}#{filePath} /mnt')
